window.__ModuleLoader__.load({
	id: "@wangjunjian/dsh-artifact-viewer",
	factory: (require) => {
		var module = { exports: {} };
		...
		const tagId$4 = "@wangjunjian/dsh-artifact-viewer/ArtifactMessageImages.module.css";
		...
		function collectToolArtifacts(node, add) {
			...
			for (const view of views) {
				...
				const fileView = view;
				if (fileView.card === "diff" || fileView.card === "generic" && fileView.kind === "edit") for (const location of fileView.locations ?? []) {
		...
		const tagId$3 = "@wangjunjian/dsh-artifact-viewer/ArtifactPreview.module.css";
		...
		const tagId$2 = "@wangjunjian/dsh-artifact-viewer/ArtifactList.module.css";
		...
		const tagId$1 = "@wangjunjian/dsh-artifact-viewer/ArtifactPanel.module.css";
      ...
      `;
		...
		const tagId = "@wangjunjian/dsh-artifact-viewer/ArtifactToggle.module.css";
